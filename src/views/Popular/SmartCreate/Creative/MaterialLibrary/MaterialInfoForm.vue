...
<!--        </el-form-item>-->
        <el-form-item prop="product_industry">
            <el-select v-model="searchForm.product_industry" placeholder="选择行业" filterable multiple collapse-tags clearable class="middle-item">
...
<!--        </el-form-item>-->
        <el-form-item prop="label_ids" >
            <el-select v-model="searchForm.label_ids" placeholder="选择标签" @visible-change="handleLabelList" filterable multiple collapse-tags clearable class="middle-item">
        ...
        <el-form-item prop="origin_id">
            <el-select v-model="searchForm.origin_id" placeholder="选择来源" clearable class="middle-item">
...
<!--        </el-form-item>-->
        <el-form-item prop="operate_content">
            <el-input prefix-icon="el-icon-search" :placeholder="isVideo?'请输入视频名称':'请输入图片名称'" v-model="searchForm.inputValue" class="middle-item" clearable>
            </el-input>
        </el-form-item>
        <el-form-item>
