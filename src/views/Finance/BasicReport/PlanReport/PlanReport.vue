<template>
    <div class="flex-vertical flex-1">
        ...
        <basic-report
            ...
            :tableHeader="header"
            showCost="plan"
            storageName="financeCenterPlanReport"
            sumUrl="/report/finance/schedule-by-inventory-sum"
            tableDataUrl="/report/finance/schedule-by-inventory"
...
import {planList, header} from "@views/Finance/BasicReport/PlanReport/PlanReport.js";
...
export default {
    ...
    methods: {
        ...
        planReportPlatform() {
            this.$http.get("/report/finance/get-schedule-inventory").then(res => {
                if (res.data.code === 200) {
